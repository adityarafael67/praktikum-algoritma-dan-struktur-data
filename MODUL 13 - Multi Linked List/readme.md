...
## Dasar Teori
Multi Linked List merupakan sekumpulan linked list yang berbeda namun saling memiliki keterhubungan satu sama lain. Setiap elemen dalam multi linked list dapat membentuk sebuah list tersendiri. Umumnya, struktur ini terdiri dari list induk dan list anak, di mana list induk berfungsi sebagai penghubung ke list anak,satu elemen pada list induk dapat memiliki lebih dari satu elemen pada list anak.
...
#### Output:
![alt text](https://github.com/adityarafael67/praktikum-algoritma-dan-struktur-data/blob/main/Asset/Screenshot%202025-12-30%20151839.png?raw=true)


Program ini dibuat untuk mengelola data mahasiswa menggunakan struktur Multi Linked List berbentuk circular,setiap node menyimpan data mahasiswa dan terhubung membentuk lingkaran.

#### Full code Screenshot:
![alt text](https://github.com/adityarafael67/praktikum-algoritma-dan-struktur-data/blob/main/Asset/Screenshot%202025-12-30%20151850.png?raw=true)
![alt text](https://github.com/adityarafael67/praktikum-algoritma-dan-struktur-data/blob/main/Asset/Screenshot%202025-12-30%20151900.png?raw=true)
![alt text](https://github.com/adityarafael67/praktikum-algoritma-dan-struktur-data/blob/main/Asset/Screenshot%202025-12-30%20151908.png?raw=true)

## Kesimpulan
Praktikum ini sangat melatih kewaspadaan dalam mengelola memori dan pointer agar tidak terjadi kesalahan saat melakukan insert atau delete. MLL adalah jembatan penting untuk memahami konsep struktur data yang lebih abstrak seperti Graph dan Tree.
